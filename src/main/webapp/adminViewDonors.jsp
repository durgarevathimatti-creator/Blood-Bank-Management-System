...
<!DOCTYPE html>
<html><head><meta charset="UTF-8"><title>Manage Donors - Admin</title>
<style> 
    body {
...
<body>
<a href="adminDashboard.jsp" class="btn logout">Back to Admin Panel</a>
<div class="container">
    <h1>Manage Donors</h1>
    <h3 style="color:yellow;">${param.msg}</h3>
    <table>
        <tr><th>ID</th><th>Name</th><th>Email</th><th>Blood Group</th><th>Contact</th><th>Actions</th></tr>
        <%
        ...
        <tr>
            ...
            <td>
                <a href="adminUpdateDonor.jsp?id=<%=d.getId()%>" style="background:#1b5e20;">Update</a>
                <a href="deleteDonor?id=<%=d.getId()%>" onclick="return confirm('Delete this donor?')" style="background:#b71c1c;">Delete</a>
            </td>
        </tr>
        <%}%>
    </table>
