...
<!DOCTYPE html>
<html><head><meta charset="UTF-8"><title>Donor Registration</title>
<style>
    body {
...
<div class="container">
    ...
    <form action="donorRegister" method="post">
        ...
        <input type="text" name="bloodGroup" placeholder="Blood Group (e.g. O+)" required><br>
        <input type="text" name="address" placeholder="City/Address" required><br>
